...
<link href="<?php echo e(URL::asset('assets/libs/alertifyjs/alertifyjs.min.css')); ?>" rel="stylesheet">
                        ...
                        <div class="p-2">
                            ...
                            <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false" aria-atomic="true">
                                <div class="toast-header">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt="" class="me-2" height="18">
...
<script src="<?php echo e(URL::asset('assets/libs/alertifyjs/alertifyjs.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/pages/notification.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Dason-Laravel_v1.0.0\Admin\resources\views/extended-notifications.blade.php ENDPATH**/ ?>